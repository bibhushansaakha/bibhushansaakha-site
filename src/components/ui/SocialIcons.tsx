...
export function XIcon({ size = 20, className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M18.24 2h3.3l-7.2 8.24L22.8 22h-6.62l-5.2-6.8L4.9 22H1.6l7.7-8.8L1.2 2h6.78l4.7 6.2L18.24 2Zm-1.16 18h1.83L7.02 3.9H5.06L17.08 20Z" />
    </svg>
  );
}
